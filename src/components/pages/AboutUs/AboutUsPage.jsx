  ...
  return (
    <main>
      <CustomContainer>
        ...
        <div className="flex flex-col gap-5 mt-10 text-justify text-lg">
          <p>
          ...
          <p>
            ...
            lokasinya berada di tengah taman, maka retribusi yang harus
            dibayarkan adalah biaya untuk masuk ke taman. Namun biaya ini juga
            tidak mahal hanya bekisar 5 ribu atau 10 ribu saja.
          </p>
          <p>
            ...
            antar 2 ribu hingga 5 ribu Tentu saja biaya ini sangat murah.
            Apalagi mengingat monumen ini sangat menarik untuk dikunjungi.
          </p>
        </div>
      </CustomContainer>
    </main>
